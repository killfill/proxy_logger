...
* Use socat with verbose or something similar and let it print the message to the terminal.
  Problem -> If your not on a unix mashine, you will need to have a remote user/pass to one. Not all people are good with or like terminals...
             You need to manually separate the request and response and copy/paste them to separate files.
